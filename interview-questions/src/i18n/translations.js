...
const ui = {
  ru: {
    ...
    suggestionDelete: '🗑 Удалить',
    suggestionDeleting: 'Удаляем…',
    suggestionDeleteConfirm: 'Удалить этот вопрос из общего списка?',
    suggestionDeleteError: 'Не удалось удалить вопрос. Проверьте вход и попробуйте ещё раз.',
    adminTitle: 'Вход администратора',
    adminEmailLabel: 'Email',
    adminPasswordLabel: 'Пароль',
    adminSignIn: 'Войти',
    adminSigningIn: 'Входим…',
    adminSignInError: 'Не удалось войти. Проверьте email и пароль.',
    adminSignOut: 'Выйти',
  ...
  en: {
    ...
    suggestionDeleting: 'Deleting…',
    suggestionDeleteConfirm: 'Delete this question from the shared list?',
    suggestionDeleteError: 'Could not delete the question. Check your sign-in and try again.',
    adminTitle: 'Administrator sign-in',
    adminEmailLabel: 'Email',
    adminPasswordLabel: 'Password',
    adminSignIn: 'Sign in',
    adminSigningIn: 'Signing in…',
    adminSignInError: 'Could not sign in. Check your email and password.',
    adminSignOut: 'Sign out',
    adminLoggedIn: 'You are signed in as administrator',
  },
};
